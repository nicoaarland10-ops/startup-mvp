...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
          d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-1a4 4 0 100-8 4 4 0 000 8zm6 4a4 4 0 00-3-3.87M9 12a4 4 0 100-8 4 4 0 000 8z" />
      </svg>
    ),
  },
  {
  ...
  return (
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="px-5 py-4 border-t border-gray-100">
        <p className="text-xs text-gray-400">Running on demo data</p>
      </div>
    </div>
  )
}
